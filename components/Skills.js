...
const SKILL_TABS = {
  Frontend: {
    ...
    skills: [
      ...
      { name: 'TypeScript',    logo: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg', level: 75, projects: 3 },
  ...
  Backend: {
    ...
    skills: [
      { name: 'Node.js',    logo: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg',  level: 88, projects: 5 },
      { name: 'Express.js', logo: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg', level: 85, projects: 5 },
      { name: 'MongoDB',    logo: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg', level: 82, projects: 4 },
      { name: 'MySQL / SQL', logo: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg',    level: 75, projects: 2 },
      { name: 'REST APIs',  logo: 'https://www.vectorlogo.zone/logos/getpostman/getpostman-icon.svg',               level: 90, projects: 5 },
      { name: 'WebRTC',     logo: 'https://cdn.simpleicons.org/webrtc/333333',                                      level: 78, projects: 2 },
      { name: 'Socket.io',  logo: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/socketio/socketio-original.svg', level: 80, projects: 3 },
      { name: 'JWT & Auth', logo: 'https://cdn.simpleicons.org/jsonwebtokens/000000',                              level: 86, projects: 4 },
    ],
  },
  DevOps: {
    color: '#EC4899',
    ...
    skills: [
      ...
      { name: 'Docker', logo: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg', level: 70, projects: 2 },
      { name: 'Vercel', logo: 'https://assets.vercel.com/image/upload/v1588805858/repositories/vercel/logo.png', level: 88, projects: 4 },
  ...
  Tools: {
    ...
    skills: [
      { name: 'Postman',  logo: 'https://www.vectorlogo.zone/logos/getpostman/getpostman-icon.svg', level: 88, projects: 5 },
      { name: 'Vite',     logo: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vite/vite-original.svg', level: 85, projects: 4 },
